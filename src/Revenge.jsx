...
const Revenge = ({
  ...
  useEffect(() => {
    if (!revengeTrigger1 && loc1 === locCell && activePlayer === player2) {
      setPlayer1((prev) => ({
        ...prev,
      ...
      alert("Revenge triggered for Player 1 against Player 2");
    }

    if (!revengeTrigger2 && loc2 === locCell && activePlayer === player1) {
      setPlayer2((prev) => ({
        ...prev,
        amount: prev.amount + 25000,
      }));
      ...
      alert("Revenge triggered for Player 2 against Player 1");
    }
  }, [
    activePlayer,
    player1,
